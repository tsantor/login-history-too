ace.define(
  ...
  function (e, t, n) {
    ...
    function k(e, t) {
      this == v.keyMap.vim &&
        v.addClass(e.getWrapperElement(), 'cm-fat-cursor'),
        (!t || t.attach != k) && T(e);
    }
    function L(e, t) {
        ...
        e.operation(function () {
          ...
          for (var o = 0; o < r; o++) {
            ...
            if (!u) {
              s = e.getSearchCursor(
                n,
                t ? S(e.lastLine()) : S(e.firstLine(), 0),
              );
              if (!s.find(t)) return;
            }
          }
    ...
    function sr(e, t, n, r) {
      function u() {
        s
          ? dt.processAction(e, t, t.lastEditActionCommand)
          : dt.evalInput(e, t);
      }
      function a(n) {
    ...
    function cr(e, t, n) {
      ...
      else if (s || !o || e.ace.inVirtualSelectionMode)
        r = x.handleKey(e, t, n);
      else {
        var u = lr(i);
        e.operation(function () {
          ...
          (this.listSelections = function (e) {
            ...
            return !t.length || this.ace.inVirtualSelectionMode
              ...
              : t.map(function (e) {
                  return {
                    anchor: this.clipPos(
                      g(e.cursor == e.end ? e.start : e.end),
                    ),
        ...
        (e.prototype.clear = function () {
          ...
          (this.findPosV = function (e, t, n, r) {
            ...
            if (n == 'line') {
              ...
              var u = this.ace.session.screenToDocumentPosition(
                o.row,
                o.column,
              );
              return g(u);
    ...
    Un.prototype = {
      ...
      parseInput_: function (e, t, n) {
        ...
        var r = t.match(/^(\w+)/);
        return (
          r ? (n.commandName = r[1]) : (n.commandName = t.match(/.*/)[0]), n
        );
      },
          ...
          function u() {
            if (t.argString) {
              ...
              if (u[1]) {
                ...
                var a =
                    u[1].indexOf('d') != -1 || (u[1].indexOf('n') != -1 && 1),
                  f = u[1].indexOf('x') != -1 && 1,
                  l = u[1].indexOf('o') != -1 && 1;
